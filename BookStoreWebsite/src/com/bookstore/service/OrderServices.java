...
public class OrderServices {
	...
	public void listAllOrder(String messgae) throws ServletException, IOException {
	...
	session.setAttribute("total", total);
	  ...
	  CommonUtility.generateCountryList(request);
		//forward request to checkout.jsp page
  ...
  BookOrder order=readOrderInfo();
	...
	public Integer placeOrderPaypal(Payment payment) {
		//update order details with recipient info and order detail that can be changed by customer
	...
	private void placeOrderCOD(BookOrder order) throws ServletException, IOException {
       ...
       */
        ...
        String message="Thank You. Your Order has been received."
                    + "We will deliver your order within a few days.";
