...
public class PaymentServices {
	...
	//sandbox
	//private static final String CLIENT_ID = "AUxgBpaUZaxBRUr3fPcReU5RYfo2fV1pKdeohUiV7ZTeKyFSC4RIYXktl0kGvkT2mxAQ5nrggc8Lwv18";
	//private static final String CLIENT_SECRET = "EJQLBFpe6F2yU5nB3t31x-y3sYUzGVYJMAhQWZqVIAW39Z0OLAVIDbl-LorSgkDobeCrFFHN9wKwwnAo";
	
	//live:
	private static final String CLIENT_ID = "AawdSJnkHvq1rKEfhJyz-bOAKAK_4NyGeIURS6GzDhAFqQyV4wjEBl3bSm-sYqub8fKxrVpMggJGoHYf";
	private static final String CLIENT_SECRET = "EBBfoeMOQ5whsW-gkmNqR0wWKFXXjdUmt4gFJC4cPeGgVWuOaaIhdh3fAPGGcXAvi7blbf3VRKy8Fhpv";
	...
	public void authorizePayment(BookOrder order) throws ServletException, IOException {
		...
		// redirect to paypals payment page
	...
	private List<Transaction> getTransactionInformation(BookOrder order) {
		...
		transaction.setDescription("Books Ordered on Online Store");
		Amount amount = getAmountDetails(order);
